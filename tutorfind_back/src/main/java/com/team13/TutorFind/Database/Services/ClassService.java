...
public class ClassService {
    ...
    public ClassResponse createClass(Long tutorId, CreateClassRequest request) {
        ...
        newClass.setScheduleTime(request.getScheduleTime());
    ...
    public ClassResponse updateClass(Long classId, Long tutorId, CreateClassRequest request) {
        ...
        if (request.getScheduleDay() != null) classEntity.setScheduleDay(request.getScheduleDay());
        if (request.getScheduleTime() != null) classEntity.setScheduleTime(request.getScheduleTime());
    ...
    private ClassResponse buildClassResponse(Class classEntity) {
        ...
        response.setAvailableSeats(classEntity.getMaxStudents() - classEntity.getCurrentStudents());
