...
public class ClassResponse {
    ...
    public static class AvailabilitySlotInfo {
        private Long id;
    ...
    private AvailabilitySlotInfo availabilitySlot;
    ...
    public AvailabilitySlotInfo getAvailabilitySlot() {
        return availabilitySlot;
    }
    
    public void setAvailabilitySlot(AvailabilitySlotInfo availabilitySlot) {
